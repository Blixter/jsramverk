        ...
        <div className="form-wrapper">
          ...
          <form onSubmit={this.handleSubmit} noValidate>
            <div className="firstName">
              ...
              <input
                type="text"
                className={formErrors.firstName.length > 0 ? "error" : this.state.firstName ? "correct" : null}
            ...
            <div className="lastName">
              ...
              <input
                type="text"
                className={formErrors.lastName.length > 0 ? "error" : this.state.lastName ? "correct" : null}
            ...
            <div className="gdpr">
              ...
              />
              <div className="gdpr-text">By checking this you agree that your personal data will be stored in our database.</div>
              </div>
