...
class Weeks extends Component {
    ...
    render() {
        ...
        return (
            <main>
                <h1>Reports</h1>
                <p>Här samlar jag veckornas alla redovisningstexter,
                    det är även här jag kan gå in och redigera samt lägga till nya texter.</p>
                <p>Kursen läses på Blekinge Tekniska Högskola,
                    som ingår i programmet Webbprogrammering.
                <a href="https://jsramverk.me/"> https://jsramverk.me/</a></p>
                <div className="row">
                    ...
                    <div className="col-lg-4">
                        <h2>Kmom03</h2>
                        <p>Den tredje veckan var fokus på Backend.
                            Vi kopplar samman frontend med backend.</p>
                ...
                <div className="row">
                    <div className="col-lg-4">
                        <h2>Kmom04</h2>
                        <p>Fokuserar på testning - enhetstestning,
                            intergrationstestning och funktionstestning.</p>
                        <Link to="/reports/week/4">Länk till redovisningstexten</Link>
                    </div>
                    <div className="col-lg-4">
                        <h2>Kmom05</h2>
                        <p>Denna vecka lärde vi oss att arbeta med
                            websockets för realtidsprogram.</p>
