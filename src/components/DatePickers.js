                        ...
                        <select
                            ...
                            className=
                                {this.props.formErrors.month.length > 0
                                    ? "error form-control" : this.props.sendState.month
                                        ? "correct form-control" : "form-control"}
                            noValidate
                        ...
                        <input
                            ...
                            className=
                                {this.props.formErrors.day.length > 0
                                    ? "form-control error" : this.props.sendState.day
                                        ? "form-control correct" : "form-control"}
                            placeholder="Day"
                            name="day"
                            min="1"
                            max="31"
                        ...
                        <input
                            ...
                            className=
                                {this.props.formErrors.year.length > 0
                                    ? "error form-control" : this.props.sendState.year
                                        ? "correct form-control" : "form-control"}
                            placeholder="Year"
                            name="year"
                            min="1900"
